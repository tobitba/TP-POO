...
public class PaintPane extends BorderPane {
	...
	public PaintPane(CanvasState canvasState, StatusPane statusPane) {
		...
		canvas.setOnMouseDragged(event -> {
			if(selectionButton.isSelected()) {
				...
				if(selectedFigure instanceof Rectangle) {   //HACER COMO MOVABLE POINT; UN ARRAY DE POINT Y UN METODO MOOVE EN FIGURE
	...
	void redrawCanvas() {
		...
		for(Figure figure : canvasState.figures()) {
			...
			if(figure instanceof Rectangle) {
				Rectangle rectangle = (Rectangle) figure; //RARO
	...
	boolean figureBelongs(Figure figure, Point eventPoint) { //tendria que estar en figure o algo parecido
		boolean found = false;
		if(figure instanceof Rectangle) {
